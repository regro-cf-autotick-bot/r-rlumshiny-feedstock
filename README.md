...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-rlumshiny-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rlumshiny-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-rlumshiny
# for installing globally
pixi global install r-rlumshiny
```
...
It is possible to list all of the versions of `r-rlumshiny` available on your platform:
...
```
pixi search r-rlumshiny --channel conda-forge
```
